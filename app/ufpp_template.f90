...
!-----------------------------------------------------------------------------------------------------------------------------------
program ufpp_template
use M_kracken, only : kracken, lget
implicit none

! ident_1="@(#)UFPP::ufpp_template(1f) write a template of a ufpp source file"
