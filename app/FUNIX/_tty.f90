...
'NAME                                                                                                                            ',&
'   _tty(1f) - [FUNIX:FILESYSTEM] print information about the file/terminal                                                      ',&
...
'   returned as unit 0. But if I call the _tty from within vim(1) it is                                                          ',&
'   returned as 5.                                                                                                               ',&
'                                                                                                                                ',&
'        _tty                                                                                                                    ',&
'        > for INPUT_UNIT=5                                                                                                      ',&
...
'@(#)COMPILED:       2021-08-21 22:20:36 UTC-240>',&
'']
