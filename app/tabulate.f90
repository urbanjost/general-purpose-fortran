...
'NAME                                                                            ',&
'   tabulate(1f) - [M_messages] write out a row of numbers and a                 ',&
'   text-based scaled graph                                                      ',&
'   (LICENSE:PD)                                                                 ',&
'                                                                                ',&
'SYNOPSIS                                                                        ',&
...
'                                                                                ',&
'DESCRIPTION                                                                     ',&
'   tabulate(1f) makes it very easy to find values in particular ranges in       ',&
'   printed output. It works particularly well with the once ubiquitous          ',&
'   fan-fold paper.                                                              ',&
'                                                                                ',&
'   It can be used in scripts to make terminal-based monitors of resources       ',&
'   such as memory, CPU load, and file space.                                    ',&
'                                                                                ',&
'   Given a max and min value for setting up a range read columns of             ',&
'   numbers and write the numbers back out with a text-based graph               ',&
'   scale appended. Each column of numbers is written with a format of           ',&
'   "1x,g14.7", taking up 15 characters per number.                              ',&
'                                                                                ',&
...
'             If set to 0, it pads out to 132 columns unless the scale           ',&
'             would be less than 15 characters wide; then it pads out to         ',&
'             255 characters                                                     ',&
'    -fill    the character to fill the graph background with. Defaults          ',&
'             to space.                                                          ',&
...
'@(#)LANGUAGE:       Fortran>',&
'@(#)COMPILED:       2024-12-14 21:41:01 UTC-300>',&
'']
