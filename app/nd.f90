...
!     define the command options and default values and apply arguments from user command line
   call setup()
   call set_args(' --percent:p 0.0001d0 --digits:d 0 --margin:m 0 --old:o " " --new:n " "', help_text, version_text)
...
'     and equals, or vertical line characters (" ,;=|"). Adjacent delimiters',&
'     are treated as a single delimiter.                                    ',&
'                                                                           ',&
'   Three basic mutually exclusive numeric comparision methods are          ',&
'   available:                                                              ',&
'                                                                           ',&
'   o number of significant digits                                          ',&
'   o A basic percent difference,                                           ',&
'   o a relative margin of the magnitude of the values                      ',&
'                                                                           ',&
'   This program was originally written to simplify the comparison of       ',&
'   values generated by new versions of numeric libraries to previous       ',&
...
'                                                                           ',&
'    -digits N            set threshold at which to report values as a      ',&
'                         number of digits.                                 ',&
'                                                                           ',&
'    -margin XXX.XX       set threshold to a relative margin of the         ',&
'                         magnitude of the values.                          ',&
'                                                                           ',&
'    -verbose             shows the lines that pass the criteria from       ',&
'                         OLDFILE as well.                                  ',&
'                                                                           ',&
'   STANDARD OPTIONS                                                        ',&
'                                                                           ',&
...
'                                                                           ',&
'    --usage              Lists the option keywords and their short         ',&
'                         and long names as defined.                        ',&
'                                                                           ',&
