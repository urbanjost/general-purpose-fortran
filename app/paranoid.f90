...
!-----------------------------------------------------------------------------------------------------------------------------------
   ...
   call system_uname('s',string) ; write(*,*)'sysname:  '//trim(string)
   call system_uname('r',string) ; write(*,*)'release:  '//trim(string)
   call system_uname('v',string) ; write(*,*)'version:  '//trim(string)
   call system_uname('n',string) ; write(*,*)'nodename: '//trim(string)
   call system_uname('m',string) ; write(*,*)'machine:  '//trim(string)
...
'@(#)COMPILED:       2025-02-23 19:24:42 UTC-300>',&
'']
