...
!-----------------------------------------------------------------------------------------------------------------------------------
   call kracken('_printenv',' -C .F. -B .F. -help .F. -version .F. ')        ! crack command line arguments
   call help_usage(lget('_printenv_help'))                                   ! display help if -help specified and stop
   call help_version(lget('_printenv_version'))                              ! display version if -version specified and stop
   Csyntax=lget('_printenv_C')                                               ! if -C specified write output for csh(1)
   Bsyntax=lget('_printenv_B')                                               ! if -B specified write output for sh(1)
   printedsome=.false.                                                       ! flag if nothing else printed to print all values
!-----------------------------------------------------------------------------------------------------------------------------------
   names=sgets('_printenv_oo')                                               ! get list of individual names (assumed no spaces)
