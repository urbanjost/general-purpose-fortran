...
logical :: allpassed
integer :: i
   call unit_test_start('glob',' -description ''match string with a pattern containing * and ? wildcard characters'' '//OPTIONS)
  allpassed = .true.
...
character(len=:),allocatable :: targetline
   ...
   call unit_test_start('replace',' '//OPTIONS)
   ...
   call unit_test_done('replace',msg='finished test of replacing substrings')
...
character(len=:),allocatable  :: s(:)
   ...
   call unit_test_done('join',msg='join array of strings into a single string controlling separators and white space')
contains
...
subroutine test_base()
   ...
   call unit_test_start('base',' '//OPTIONS)
...
integer,allocatable          :: expected(:)
   call unit_test_start('decodebase',' '//OPTIONS)
   ...
   call unit_test_done('decodebase')
contains
...
character(len=:),allocatable :: in(:)
integer,allocatable          :: expected(:)
   call unit_test_start('base2',' '//OPTIONS)
...
character(len=:),allocatable :: in(:)
integer,allocatable          :: expected(:)
   call unit_test_start('codebase',' '//OPTIONS)
...
!-----------------------------------------------------------------------------------------------------------------------------------
   call unit_test_start('substitute','-description ''subroutine globally replaces old substring with new string'' '//OPTIONS)
...
!-----------------------------------------------------------------------------------------------------------------------------------
   call unit_test_good('substitute')
!-----------------------------------------------------------------------------------------------------------------------------------
...
integer             :: ier
   ...
   call unit_test_start('change',' -description ''replace substring with new string with a directive like line editor'' '//OPTIONS)
   call change(line, 'c/ain/AIN'     ,ier)
   if(unit_test_level > 0)then
      write(std_err,g)'IER=',ier
   endif
   call unit_test('change',ier == 4,'without trailing slash')

   call change(line, 'c/ The r/R/'   ,ier)
   if(unit_test_level > 0)then
      write(std_err,g)'IER=',ier
   endif
   call unit_test('change',ier == 1,'with trailing slash')

   call change(line, 'c/ /'          ,ier)
   if(unit_test_level > 0)then
      write(std_err,g)'IER=',ier
   endif
   call unit_test('change',ier >= 7,'no new string') ! remove spaces

   call change(line, 'c//PREFIX:'    ,ier)
   if(unit_test_level > 0)then
      write(std_err,g)'IER=',ier
   endif
   call unit_test('change',ier == 1,'null new string')

   call change(line, 'c/XYZ/xxxxxx:' ,ier)
   if(unit_test_level > 0)then
      write(std_err,g)'IER=',ier
   endif
   call unit_test('change',ier == 0,'no matching old string')
   ...
   call unit_test_done('change') ! indicate test of change(3f) passed
...
integer                       :: is,ie
integer                       :: itoken
   call unit_test_start('strtok',' '//OPTIONS)
...
character(len=:),allocatable :: COMMAND_LINE
   ...
   call unit_test_done('modif')
end subroutine test_modif
!TTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTT
subroutine test_len_white()
   call unit_test_start('len_white',' &
   ...
   call unit_test_done('len_white',msg='len_white(3f) tests completed')
end subroutine test_len_white
!TTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTT
subroutine test_clip()
   call unit_test_start('clip',' &
   ...
   call unit_test_done('clip')
end subroutine test_clip
!TTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTT
subroutine test_crop()
   call unit_test_start('crop',' &
      & -description ''function trims leading and trailing spaces'' '//OPTIONS )
...
character(len=36),parameter :: lc='abcdefghijklmnopqrstuvwxyz0123456789'
character(len=36),parameter :: uc='ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789'
   call unit_test_start('transliterate',' &
...
call unit_test_done('transliterate')
end subroutine test_transliterate
!TTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTT
subroutine test_rotate13()
character(len=:),allocatable  :: s
character(len=:),allocatable  :: e
   call unit_test_start('rotate13',' -description ''apply trivial encryption algorithm ROT13 to a string'' '//OPTIONS )
   ...
   call unit_test_done('rotate13',msg='')
...
character(len=36),parameter :: lc='abcdefghijklmnopqrstuvwxyz0123456789'
!-----------------------------------------------------------------------------------------------------------------------------------
   call unit_test_start('reverse',' -description ''elemental function reverses character order in a string'' '//OPTIONS )
...
!-----------------------------------------------------------------------------------------------------------------------------------
   call unit_test_start('upper',' -description ''elemental function converts string to uppercase'' '//OPTIONS )
   call unit_test('upper',upper(lc) == uc,upper(lc))
   call unit_test('upper',upper(lc,9,14) == rnge,'range',upper(lc,9,14),'expected',rnge)
   call unit_test_done('upper')
!-----------------------------------------------------------------------------------------------------------------------------------
...
character(len=36),parameter :: rnge='ABCDEFGHijklmnOPQRSTUVWXYZ0123456789'
!-----------------------------------------------------------------------------------------------------------------------------------
   call unit_test_start('lower',' -description ''elemental function converts string to miniscule'' '//OPTIONS )
...
integer :: i
character(len=80) :: line
   call unit_test_start('expand','  -description ''expand escape sequences in a string'' '//OPTIONS )
...
integer                      :: iout
   ...
   call unit_test_done('notabs',msg='')
...
subroutine test_stretch()
   call unit_test_start('stretch',' -description ''return a string of at least specified length'' '//OPTIONS )
   ...
   call unit_test_done('stretch',msg='tests completed')
end subroutine test_stretch
!TTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTT
subroutine test_pad()
   call unit_test_start('pad',' -description ''return a string of at least specified length'' '//OPTIONS )
   ...
   call unit_test('pad',len(pad('Hello World',2)) == 11 &
           ...
           msg='check not truncated')
   call unit_test_done('pad',msg='tests completed')
end subroutine test_pad
!TTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTT
subroutine test_zpad()
   call unit_test_start('zpad',' -description ''return a string left-padded with zeros'' '//OPTIONS )
   ...
   call unit_test_done('zpad',msg='tests completed')
end subroutine test_zpad
!TTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTT
subroutine test_lpad()
   call unit_test_start('lpad',' -description ''return a left-padded string'' '//OPTIONS )
   ...
   call unit_test_done('lpad',msg='tests completed')
end subroutine test_lpad
!TTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTT
subroutine test_cpad()
   call unit_test_start('cpad',' -description ''return a left-padded string'' '//OPTIONS )
   ...
   call unit_test_done('cpad',msg='tests completed')
end subroutine test_cpad
!TTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTT
subroutine test_rpad()
   call unit_test_start('rpad',' -description ''return a right-padded string'' '//OPTIONS )
   ...
   call unit_test_done('rpad',msg='tests completed')
end subroutine test_rpad
!TTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTT
subroutine test_lenset()
character(len=10)            :: string='abcdefghij'
   call unit_test_start('lenset',' -description ''return a string as specified length'' '//OPTIONS )
   ...
   call unit_test_done('lenset')
end subroutine test_lenset
!TTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTT
subroutine test_merge_str()
character(len=:), allocatable :: answer
   call unit_test_start('merge_str',' -description ''make strings of equal length and then call MERGE(3f) intrinsic'' '//OPTIONS )
...
integer           :: i10
  ! Use goodbad(1) to indicate the test sequence was begun
   call unit_test_start('noesc',' '//OPTIONS )
   do i10=0,127
...
integer           :: ierr
!===================================================================================================================================
   call unit_test_start('string_to_value',' &
...
doubleprecision SUM, SUM2, DELTA
   ...
   call unit_test_start('s2v',' -description ''function returns doubleprecision value from string'' '//OPTIONS )
...
integer           :: IERRSUM=0
!===================================================================================================================================
   call unit_test_start('value_to_string',' &
...
!===================================================================================================================================
   ...
   call unit_test_done('value_to_string')
!===================================================================================================================================
...
!   call unit_test('v2s',almost(s2v(v2s(SUM2)),SUM2,15),'doubleprecision',SUM2,s2v(v2s(SUM)))
   ...
   call unit_test_done('v2s')
end subroutine test_v2s
!TTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTT
subroutine test_isnumber
!-!use M_strings, only: isnumber
   call unit_test_start('isnumber',' '//OPTIONS )
   ...
   call unit_test_done('isnumber')
end subroutine test_isnumber
!TTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTT
subroutine test_trimzeros_()
   call unit_test_start('trimzeros_',' '//OPTIONS )
   call unit_test_done('trimzeros_',msg='UNTESTED')
...
character(len=:),allocatable :: test_out(:)
   ...
   call unit_test_start('quote',' '//OPTIONS )
...
character(len=:),allocatable :: tests(:)
   ...
   call unit_test_start('unquote',' '//OPTIONS )
   do i=1,size(tests)
      quoted_str=tests(i)
...
! initialize database description of routine
   call unit_test_start('describe',' -description ''returns a string describing character'' '//OPTIONS )
...
integer            :: icount,ierr
   call unit_test_start('getvals',' '//OPTIONS )
...
integer            :: ierr
integer            :: inums
   call unit_test_start('string_to_values',' -description ''subroutine returns values from a string'' '//OPTIONS )
   ...
   call unit_test_done('string_to_values',msg='')
...
integer,allocatable         :: ivalues(:)
   call unit_test_start('s2vs',' -description ''function returns a doubleprecision array of numbers from a string'' '//OPTIONS )

   values=s2vs(s)
   ivalues=int(s2vs(s))
   call unit_test('s2vs',size(values) == 6, msg='number of values')
   call unit_test('s2vs',all(ivalues == [10, 20000, 3, -4,1234,5678]))
   call unit_test_done('s2vs')
end subroutine test_s2vs
!TTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTT
subroutine test_squeeze()
   call unit_test_start('squeeze',' -description ''remove duplicate adjacent characters from strings'''//OPTIONS)
   ...
   call unit_test_done('squeeze')
end subroutine test_squeeze
!TTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTT
subroutine test_edit_distance()
integer,allocatable         :: ivalues(:)
   call unit_test_start('edit_distance',' -description ''return naive edit distance using Levenshtein algorithm'''//OPTIONS)
...
subroutine test_nint()
   call unit_test_start('nint',' ' //OPTIONS )
   ...
   call unit_test_done('nint',msg=' overload of NINT()')
end subroutine test_nint
!TTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTT
subroutine test_int()
   call unit_test_start('int',' ' //OPTIONS )
   call unit_test('int',int('1234') == 1234,msg='test string to integer for overloaded INT()')
   call unit_test_done('int',msg=' overload of INT()')
end subroutine test_int
!TTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTT
subroutine test_real()
   call unit_test_start('real',' '//OPTIONS )
   call unit_test('real', real('3.0d0') == 3.0d0,msg='test string to real for overloaded REAL()')
   call unit_test_done('real',msg='overload of REAL(3f)')
end subroutine test_real
!TTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTT
subroutine test_dble()
   call unit_test_start('dble',' '//OPTIONS )
   call unit_test('dble', dble('3.0d0') == 3.0d0,msg='test string to double for overloaded DBLE()')
   call unit_test_done('dble',msg='overload of DBLE(3f)')
end subroutine test_dble
!TTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTT
subroutine test_setbits()
   !character(len=:),allocatable :: string
   call unit_test_start('setbits',' -description    ''set all bits in an INTEGER word with a string'' '//OPTIONS )
   !string='11111111'
   ...
   !call unit_test('setbits',setbits(string) == 0,setbits(string))
   call unit_test_done('setbits',msg='setbits(3f) tests completed')
end subroutine test_setbits
!TTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTT
subroutine test_match_delimiter()
   !character(len=:),allocatable :: string
   call unit_test_start('match_delimiter',' -description    ''find matching delimiter'' '//OPTIONS )
   !string='11111111'
   ...
   !string='1111111111111111111111111111111111111111111111111111111111111111'
   !call unit_test('match_delimiter',match_delimiter(string) == 0,match_delimiter(string))
   call unit_test_done('match_delimiter',msg='match_delimiter(3f) tests completed')
