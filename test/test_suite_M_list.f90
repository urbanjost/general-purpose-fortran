...
type(dictionary) :: dict
   ...
   call unit_test_done('dict%set')
end subroutine test_dict_set
!TTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTT
subroutine test_dict_delete
type(dictionary) :: dict
   call unit_test_start('dict%del',&
...
logical,allocatable  :: answers(:)
   ...
   call unit_test_done('dict%ifdef')
...
integer                       :: place
integer                       :: isize
   call unit_test_start('remove',' -description "remove value from allocatable array by index"  '//share)
