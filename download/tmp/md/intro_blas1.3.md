brief discription of subroutines. BLAS routines and
...
DESCRIPTION
    ...
    A, one uses forward storage with an stride of M.  Thus a BLAS routine call with X=A(2,1) and increment/stride of INCX=M will
