...
!!    using the programming languages Fortran or C for reading hot (raw I/O)
!!    keystrokes. In this document "Hot" or "Raw" mode, also sometimes called
!!    "immediate mode" means each keystroke is detected immediately, without
